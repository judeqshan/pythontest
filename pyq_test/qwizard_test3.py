...
class WizardPage2(QWizardPage):
    ...
    def initializePage(self):
        # self.completeChanged.connect(self.next)
    ...
    def next(self):
        ...
        # result = QMessageBox.question(self, 'Message', "Do you want to close the application?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
