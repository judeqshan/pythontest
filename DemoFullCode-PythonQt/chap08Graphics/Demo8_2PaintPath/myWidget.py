...
##生成五角星的5个顶点的,假设原点在五角星中心
      ...
      deg=Pi*72.0/180   
      points=[QPoint(R,0),
              QPoint(round(R*math.cos(deg)),    round(-R*math.sin(deg))),
              QPoint(round(R*math.cos(2*deg)),  round(-R*math.sin(2*deg))),
              QPoint(round(R*math.cos(3*deg)),  round(-R*math.sin(3*deg))),
              QPoint(round(R*math.cos(4*deg)),  round(-R*math.sin(4*deg))) ]   #元组数据
